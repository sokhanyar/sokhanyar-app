...
import ir.saltech.myapps.stutter.util.ProgressRequestBody
        ...
        ApiClient.saltechAi.uploadVoice(
            ...
            _uiState.value.voice.selectedFile!!.let {
                val progressiveRequestBody =
                    ProgressRequestBody(it, "audio", object : ProgressRequestBody.UploadCallbacks {
